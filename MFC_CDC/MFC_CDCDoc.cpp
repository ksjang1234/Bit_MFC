...
// MFC_CDCDoc.cpp: CMFCCDCDoc 클래스의 구현
//
...
CMFCCDCDoc::CMFCCDCDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMFCCDCDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCCDCDoc::InitializeSearchContent()
{
...
void CMFCCDCDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
